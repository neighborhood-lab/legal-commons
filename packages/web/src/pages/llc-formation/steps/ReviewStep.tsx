  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <div className="border-b border-gray-200 dark:border-gray-700 pb-4">
          ...
          <dl className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
            <div><dt className="text-gray-600 dark:text-gray-400">State:</dt><dd className="font-medium">{formData.state}</dd></div>
            <div><dt className="text-gray-600 dark:text-gray-400">Company Name:</dt><dd className="font-medium">{formData.companyName}</dd></div>
            <div className="md:col-span-2"><dt className="text-gray-600 dark:text-gray-400">Purpose:</dt><dd className="font-medium">{formData.businessPurpose}</dd></div>
            <div><dt className="text-gray-600 dark:text-gray-400">Management:</dt><dd className="font-medium">{formData.managementType}</dd></div>
          </dl>
        </div>
        ...
        <div className="border-b border-gray-200 dark:border-gray-700 pb-4">
          ...
          <dl className="text-sm space-y-1">
            <div><dt className="text-gray-600 dark:text-gray-400">Name:</dt><dd className="font-medium">{formData.agentName}</dd></div>
            <div><dt className="text-gray-600 dark:text-gray-400">Address:</dt><dd className="font-medium">{formData.agentStreet}, {formData.agentCity}, {formData.agentState} {formData.agentZip}</dd></div>
          </dl>
        </div>
        ...
        <div>
          ...
          {formData.members.map((member, i: number) => (
            <div key={i} className="text-sm py-2">
              ...
              {member.isManager && <span className="text-primary-600 dark:text-primary-400"> (Manager)</span>}
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="bg-primary-50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800 rounded-lg p-4">
        <h4 className="font-medium text-primary-900 dark:text-primary-100 mb-2">What happens next?</h4>
